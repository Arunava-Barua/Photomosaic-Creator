...
def remove_duplicates(folder="landscapes"):
    dir = f"images/{folder}"
    toRemove = []
    num_removed = 0
...
def resize_images(folder="landscapes", size=1000):
    dir = f"images/{folder}"
    files = os.listdir(dir)
...
def treat_images(folder="landscapes", size=1000):
...
def get_best(folder="landscapes", max_avg_color_deviation=765, max_contrast=765, size=1000):
...
def get_best_colors_main(main_image, folder="landscapes", num_images=20):
    path = f"images/{folder}"
...
def create_photomosaic(main_image="cannon", images_folder="landscapes", new_name="photomosaic", num_images=False, save_fullres=True, save_lowres=True, save_gif=False, save_gif_reversed=False, save_vid=True, save_vid_reversed=True, save_zooms=True, resize_main=False, quality=85, images_size=50, max_zoomed_images=10, zoom_incr=1.05, frame_duration=30):
